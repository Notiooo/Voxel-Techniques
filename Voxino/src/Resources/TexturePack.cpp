...
std::vector<glm::vec2> TexturePack::normalizedCoordinates(Block::TextureId textureId) const
{
...
const Texture& TexturePack::texture(const TexturePack::Spritesheet& textures) const
{
    switch (textures)
    {
