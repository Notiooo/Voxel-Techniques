...
public:
    ...
    /**
     * Updates the engine logic dependent, or independent of time, every rendered frame.
    ...
    /**
     * It handles mouse behavior typical of first-person application controls.
     */
    static void handleFirstPersonBehaviour(const sf::Event& event,
                                           WindowToRender& applicationWindow);
