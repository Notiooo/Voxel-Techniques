...
#include <World/Raycast/Chunks/OctreeGpu.h>
 ...
 */
class RaycastChunkOctreeGpu : public Chunk
{
public:
    ...
    RaycastChunkOctreeGpu(const Block::Coordinate& blockPosition,
                          const TexturePackArray& texturePack);

    RaycastChunkOctreeGpu(Block::Coordinate blockPosition, const TexturePackArray& texturePack,
    ...
    {
        return mOctree.lastNumberOfRayIterations();
    }
