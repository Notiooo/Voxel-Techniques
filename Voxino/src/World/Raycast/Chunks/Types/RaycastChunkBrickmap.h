...
#include "World/Raycast/Chunks/Brickgrid.h"
 ...
 */
class RaycastChunkBrickmap : public Chunk
{
public:
    ...
    RaycastChunkBrickmap(const Block::Coordinate& blockPosition,
                         const TexturePackArray& texturePack);

    RaycastChunkBrickmap(Block::Coordinate blockPosition, const TexturePackArray& texturePack,
