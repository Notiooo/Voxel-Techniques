...
void Mesh::setTextureToShaderUniform(const Shader& shader, const Texture& texture)
{
    switch (texture.type())
    {
...
void Mesh::setDefaultValuesToMaterialUniforms(const Shader& shader)
{
...
{
    const auto it = std::ranges::find_if(textures,
